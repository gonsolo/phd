...
\definecolor{monoDeep}{HTML}{0D1F33}   % near-black navy
\definecolor{monoDark}{HTML}{1A3C5E}   % borgblue
\definecolor{monoMid} {HTML}{2E5F8A}   % mid navy
\definecolor{monoLight}{HTML}{D6E4F0}  % very pale blue
...
\definecolorstyle{Mono}{
  ...
  % title bar
  \colorlet{titlebgcolor}{monoDeep}
  ...
  \colorlet{innerblockbodybgcolor}{monoLight!30}
