...
\documentclass[a0paper,landscape,20pt]{tikzposter}
...
\definecolor{monoDeep}{HTML}{082830}   % near-black teal (from vkcube)
\definecolor{monoDark}{HTML}{085868}   % dark teal  (dominant vkcube hue)
\definecolor{monoMid} {HTML}{2E6878}   % mid teal
\definecolor{monoLight}{HTML}{C8E8E8}  % very pale teal
\definecolor{vkbg}    {HTML}{323232}   % vkcube_00.png background (sampled)

\definecolorstyle{Mono}{
  % colour definitions (unused — defined above)
}{
  \colorlet{backgroundcolor}{vkbg}
  \colorlet{framecolor}{monoDeep}
  % title bar
...
% ── Title ──────────────────────────────────────────────────────────────────
\title{\textbf{Borg}: Open-Source Tile-Based GPU with Silicon Tapeout}
